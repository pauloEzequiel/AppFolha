	    ...
	    <div class="form-group row">
	    	<div class="col-xs-8">
	    	 <label>Ocupação</label>
	      	 <input type="text" class="form-control" placeholder="Entre com a ocupação do funcionario" name="ocupacao">
	    	</div>
	    </div>
	    ...
	    <div class="form-group row">
	    	<div class="col-xs-8">
	    	 <label>Endereco</label>
	      	<input type="text" class="form-control" placeholder="Entre com o endereço do funcionario" name="endereco">
	    	</div>
	    </div>
	    <hr>
	    <div class="form-group row">
