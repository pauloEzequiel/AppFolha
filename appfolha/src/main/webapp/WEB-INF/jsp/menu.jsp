	      ...
	      <li class="class=" nav-item dropdown">
	        <a class="dropdown-toggle" href="/folhaPagamento/lista"	data-toggle="dropdown" role="button" aria-haspopup="true"
					...
					<ul class="dropdown-menu">
						...
						<li><a class="nav-link" href="/salario/lista">Salário</a></li>
						<li><a class="nav-link" href="/beneficio/lista">Benefício</a></li>
						<li><a class="nav-link" href="/devolucao/lista">Devolução</a></li>
